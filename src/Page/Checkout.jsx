    ...
    <>
      ...
      <div className=" checkout-grid">
          ...
          <ul className="form-ul">
            <li className="form-li">
              <select
                ...
                className="input-checkout">
                <option value="Country / Region" className="text-description">
                ...
                <option value="">Korea - Democratic People's Repulic of</option>
            ...
            <li className="form-li form-checkout form--checkout">
              <input
                type="text"
        ...
        <div className="contact-link payment">
          ...
          <p className="text-description">All transre secure and encrypted.</p>
        </div>
            ...
            <ul className="form-ul">
              <li className="form-li ">
                <div className="radio">
                  ...
                  <div className="footer-image credit-card-type">
                    <li className="">
                      <img src={amex} alt="" className="credit-card-img" />
                    </li>
                    <li className="">
                      <img src={discover} alt="" className="credit-card-img" />
                    </li>
                    <li className="">
                      <img src={apple} alt="" className="credit-card-img" />
                    </li>
                    <li className="">
                      <img src={master} alt="" className="credit-card-img" />
                    </li>
                    <li className="">
                      <img src={paypal} alt="" className="credit-card-img" />
                    </li>
                    <li className="">
                      <img src={visa} alt="" className="credit-card-img" />
                    </li>
                  </div>
                </div>
              </li>
